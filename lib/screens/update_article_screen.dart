...
class UpdateArticleScreen extends StatefulWidget {
  final GetArticlesModelData getArticlesModelData;
  UpdateArticleScreen({this.getArticlesModelData});
  @override
...
class _UpdateArticleScreenState extends State<UpdateArticleScreen> {
  ...
  void initState() {
    ...
    super.initState();
    titleController = TextEditingController(text: widget.getArticlesModelData.title);
    descriptionController = TextEditingController(text: widget.getArticlesModelData.description);
  }
  @override
                      ...
                      child: Form(
                        ...
                        child: Column(
                          children: [
                            ///............. image.............///
                            _image == null
                                ? widget.getArticlesModelData.image != null
                                  ?InkWell(
                                onTap: () {
                                  getImage();
                                },
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: Image.network(
                                        '$mediaUrl${widget.getArticlesModelData.image}',
                                      )),
                                ),
                              )
                                  :InkWell(
                              ...
                              onTap: () {
                                ...
                                if (articleKey.currentState.validate() && _image != null ) {
                                  ...
                                  postMethod(
                                      ...
                                      {
                                        'update_id':widget.getArticlesModelData.id,
  ...
  uploadImage(File file) async {
    ...
    try {
      response = await dio.post(updateArticlesService, data: formData);
