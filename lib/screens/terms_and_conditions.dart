              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('TERMS AND CONDITIONS OF THIS SITE:',
                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                      ),
                      SizedBox(height: 10,),
                      Text('At Online doctor.pk, we respect the privacy of everyone who visits our website '
                      ...
                      textAlign: TextAlign.left,
                       ...
                       SizedBox(height: 20,),
                      Text('OWNERSHIP AND USES OF THE SITE:',
                        style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                      ),
                      SizedBox(height: 10,),
                      Text('Online doctor owns and utilizes this website pinpointed at www.onlinedoctor.pk.'
                      ...
                      SizedBox(height: 10,),
                      Text('Online Doctor is obligated to protecting and maintaining'
                      ...
                      SizedBox(height: 20,),
                      Text('HOME LAB SAMPLING:',
                        style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                      ),
                      SizedBox(height: 10,),
                      Text('Online Doctor is offering free home sample collection services'
                      ...
                      SizedBox(height: 20,),
                      Text('MEDICINE DELIVERY AND ONLINE CONSULTATION:',
                        style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold),
                      ),
                      SizedBox(height: 10,),
                      Text('Now you don\'t have to go out for bringing your medicines.'
                      ...
                      SizedBox(height: 10,),
                      Text('We collect the said information when you register on our'
                      ...
                      SizedBox(height: 10,),
                      Text('Make a purchase Sign up for our email list or newsletter'
                      ...
                      SizedBox(height: 10,),
                      Text('To personalize your website experience and offer you content and products as per your inclinations.'
